...
def solve():
    with open("./input_5.txt") as steps_text:
        ...
        while True:
            ...
            if opcode == 1:
                first_value, instruction = step_tracker.get_next_value(instructions)
                second_value, instruction = step_tracker.get_next_value(instructions)
                ...
                first_value, instruction = step_tracker.get_next_value(instructions)
                if first_value != 0:
                    step_tracker.current_step_index = step_tracker.steps[step_tracker.current_step_index + 1]
                else:
                    step_tracker.current_step_index += 3
            elif opcode == 6:
                first_value, instruction = step_tracker.get_next_value(instructions)
                if first_value == 0:
                    step_tracker.current_step_index = step_tracker.steps[step_tracker.current_step_index + 1]
                ...
                if first_value < second_value:
                    step_tracker.steps[step_tracker.steps[step_tracker.current_step_index]] = 1
                else:
                    step_tracker.steps[step_tracker.steps[step_tracker.current_step_index]] = 0
                step_tracker.current_step_index += 1
            elif opcode == 8:
                first_value, instruction = step_tracker.get_next_value(instructions)
                second_value, instruction = step_tracker.get_next_value(instructions)
                if first_value == second_value:
