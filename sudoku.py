...
def validate_sudoku_matrix(matrix):
    ...
    for i in range(9):
        # validate columns
        if not validate_group([row[i] for row in matrix]):
            return False
    return True
...
assert validate_sudoku_matrix(solve([
    ...
    [1, None, None, 8, None, 3, None, None, 7],
    [9, None, None, 5, None, None, None, 6, None],
    [None, None, 4, None, None, None, None, None, None],
    [None, None, None, None, 6, None, 2, 8, None],
    [5, 6, None, 4, None, None, None, 3, None]
]))
